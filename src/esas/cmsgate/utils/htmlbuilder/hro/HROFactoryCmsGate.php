...
use esas\cmsgate\utils\htmlbuilder\hro\pages\AdminLoginPageHRO;
use esas\cmsgate\utils\htmlbuilder\hro\pages\AdminLoginPageHRO_v1;
...
class HROFactoryCmsGate implements HROFactory
{
    ...
    public static function getInstance() {
        if (self::$instance == null)
            self::$instance = new HROFactoryCmsGate();
    ...
    public function createAdminLoginPageBuilder() {
        return AdminLoginPageHRO_v1::builder();
    }
}